package com.rest.autotests.utils.reporting;
    ...
    private void resultSummary(ISuite suite, IResultMap tests, String testname, String style,
        ...
        if (tests.getAllResults().size() > 0) {
            ...
            for (ITestNGMethod method : getMethodSet(tests, suite)) {
                ...
                String linkSection = (style.equals("failed")) ? "<td><div><a href=\"\" class=\"spoiler_links\">expand</a><div style=\"display: none\" class=\"spoiler_body\"><img width=\"400\" height=\"640\" src=\"http:screenshot/" + testClass.getName() + "%23" + method.getMethodName() + ".png\"></div></div></td>" : " ";
                buff.append("<td>" + qualifiedName(method)+ "</td>"
                        + "<td>" + description + "</td>"
//                        + "<td class=\"numi\">" + resultSet.size() + "</td>"
                        + "<td class=\"numi\">" + (end - start) / 1000 + "</td>"
//                        + linkSection
                        + "</tr>");
            }
            if (mq > 0) {
...
//                + "<th>Method</th><th># of<br/>Scenarios</th><th>Time<br/>(s)</th><th>Screenshot</th></tr>");
                + "<th>Method</th><th>Name</th><th>Time<br/>(s)</th></tr>");
        m_row = 0;
    }
    ...
    protected void startHtml(PrintWriter out) {
        ...
        out.println("$('.spoiler_links').click(function(){");
        out.println("$(this).parent().children('div.spoiler_body').toggle('normal');");
